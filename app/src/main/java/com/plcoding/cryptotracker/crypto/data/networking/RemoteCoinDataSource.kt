...
class RemoteCoinDataSource(
    ...
    override suspend fun getCoinHistory(
        ...
        val startMillis = getTimeInMilli(start)
        val endMillis = getTimeInMilli(end)
...
private fun getTimeInMilli(date: ZonedDateTime): Long {
    return date.withZoneSameInstant(ZoneId.of("UTC")).toInstant().toEpochMilli()
}
